    ...
    try {
      ...
      for (const update of data.result) {
        ...
        if (lowerText === "/start") {
            ...
            Этот бот считает разницу между Rocket курсом и BB курсом, прибыль офиса и сохраняет историю расчетов.
            ...
            ⚠️ Эта команда удаляет всю историю расчетов.

            ━━━━━━━━━━━━━━━
            🌐 САЙТ-КАЛЬКУЛЯТОР
            ━━━━━━━━━━━━━━━

            https://azizbektakhirov33.github.io/telegram-calculator-bot/frontend/index.html

            Логин: admin
            Пароль: admin

            При нажатии на кнопку “Посчитать” на сайте расчет автоматически отправляется в Telegram-чат.

            ━━━━━━━━━━━━━━━
            🔒 ДОСТУП
            ━━━━━━━━━━━━━━━

            ✅ Бот работает только в разрешенном чате
            ❌ В личке бот не принимает запросы
            ❌ В чужих группах бот не работает
            `);
            continue;
            }
